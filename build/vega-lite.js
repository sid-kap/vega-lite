(function (global, factory) {
  ...
  function rangeType(channel) {
    switch (channel) {
      ...
      case COLUMN:
      case SHAPE:
      case STROKEDASH: // TEXT, LABEL, TOOLTIP, URL, and HREF have no scale but have discrete output [falls through]
  ...
  function getPointOverlay(markDef) {
    ...
    if (markDef.point === 'transparent' || // if the main mark is a single line/trail/area chart, create an invisible point overlay for label.
  ...
  */
  ...
  class UnitModel extends ModelWithField {
    constructor(spec, parent, parentGivenName) {
      ...
      _defineProperty(this, "labelMark", void 0);

      _defineProperty(this, "avoidAncestorLevel", void 0);

      _defineProperty(this, "originalEncoding", void 0);
    ...
    parseMarkGroup() {
      var _this$encoding$label;

      const {
        mark,
        label
      } = parseMarkGroupsAndLabels(this);
      this.component.mark = mark;
      this.labelMark = label;
      this.avoidAncestorLevel = getAncestorLevel((_this$encoding$label = this.encoding.label) === null || _this$encoding$label === void 0 ? void 0 : _this$encoding$label.avoid);
    }
    ...
    assembleMarks() {
      ...
      let marks = [...((_this$component$mark = this.component.mark) !== null && _this$component$mark !== void 0 ? _this$component$mark : []), ...(this.labelMark ? [this.labelMark] : [])]; // If this unit is part of a layer, selections should augment
      ...
      marks = marks.map(this.correctDataNames); // move label marks to the top
    ...
    getMarkNames() {
      var _this$component$mark2;

      return ((_this$component$mark2 = this.component.mark) !== null && _this$component$mark2 !== void 0 ? _this$component$mark2 : []).map(m => m.name).filter(name => name);
    }
    ...
    avoidMarks(names) {
      ...
      if (this.avoidAncestorLevel > level && this.labelMark && names.length) {
        var _labelTransform$avoid;

        const [labelTransform] = this.labelMark.transform;
        (_labelTransform$avoid = labelTransform.avoidMarks) !== null && _labelTransform$avoid !== void 0 ? _labelTransform$avoid : labelTransform.avoidMarks = [];
  ...
  function isLabelMark(mark) {
    ...
    return mark.type === 'text' && ((_mark$transform = mark.transform) === null || _mark$transform === void 0 ? void 0 : _mark$transform.length) === 1 && mark.transform[0].type === 'label';
  }
  function parseMarkGroupsAndLabels(model) {
    if (contains([LINE, AREA, TRAIL], model.mark)) {
      ...
      if (details.length > 0) {
        ...
        return {
          mark: getPathGroups(model, details),
          label
        };
      ...
      if (model.stack && !model.fieldDef('size') && hasCornerRadius) {
        return {
          mark: getGroupsForStackedBarWithCornerRadius(model)
        };
      }
    }
  ...
  function getLabelInheritableChannels(mark, encoding, inherit) {
    ...
    return Object.fromEntries(vega.array(inherit).filter(channel => encoding[channel]).map(channel => [channel, encoding[channel]]));
  }
  ...
  function getLabelMark(model, data) {
    ...
    switch (mark) {
      case 'area':
        labelTransform = { ...common,
          method: method !== null && method !== void 0 ? method : 'reduced-search'
        };
        break;
      ...
      case 'bar':
        labelTransform = { ...common,
          ...(position ? {
            anchor,
            offset
          } : (stack === null || stack === void 0 ? void 0 : (_stack$stackBy = stack.stackBy) === null || _stack$stackBy === void 0 ? void 0 : _stack$stackBy.length) > 0 ? {
            anchor: ['middle'],
            offset: [0]
          } : {
      ...
      case 'rect':
        labelTransform = { ...common,
          anchor: anchor !== null && anchor !== void 0 ? anchor : ['middle'],
      ...
      default:
        labelTransform = { ...common,
          anchor: anchor !== null && anchor !== void 0 ? anchor : ['top-right', 'top', 'top-left', 'left', 'bottom-left', 'bottom', 'bottom-right', 'middle'],
          offset: offset !== null && offset !== void 0 ? offset : [2, 2, 2, 2, 2, 2, 2, 2, 2]
        };
    }
    ...
    const textSpec = {
      ...
      mark: {
        type: 'text',
        ...(labelMark !== null && labelMark !== void 0 ? labelMark : {})
      },
      encoding: {
        text: textEncoding,
        ...getLabelInheritableChannels(mark, originalEncoding, inherit)
      }
    };
    ...
    return {
      ...
      encode: {
        update: { ...omit(baseEncodeEntry(textModel, {
            align: 'ignore',
            baseline: 'ignore',
            color: 'include',
            size: 'ignore',
