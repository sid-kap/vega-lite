...
export declare const CHANNELS: ("fill" | "description" | "detail" | "key" | "url" | "color" | "fillOpacity" | "opacity" | "order" | "stroke" | "strokeOpacity" | "strokeWidth" | "label" | "text" | "size" | "x" | "x2" | "y" | "y2" | "strokeDash" | "tooltip" | "angle" | "shape" | "radius" | "theta" | "facet" | "href" | "theta2" | "radius2" | "xOffset" | "yOffset" | "longitude" | "latitude" | "longitude2" | "latitude2" | "row" | "column")[];
/**
 ...
 */
export declare const SINGLE_DEF_CHANNELS: ("fill" | "description" | "key" | "url" | "color" | "fillOpacity" | "opacity" | "stroke" | "strokeOpacity" | "strokeWidth" | "label" | "text" | "size" | "x" | "x2" | "y" | "y2" | "strokeDash" | "angle" | "shape" | "radius" | "theta" | "facet" | "href" | "theta2" | "radius2" | "xOffset" | "yOffset" | "longitude" | "latitude" | "longitude2" | "latitude2" | "row" | "column")[];
export declare type SingleDefChannel = typeof SINGLE_DEF_CHANNELS[number];
export declare const SINGLE_DEF_UNIT_CHANNELS: ("fill" | "description" | "key" | "url" | "color" | "fillOpacity" | "opacity" | "stroke" | "strokeOpacity" | "strokeWidth" | "label" | "text" | "size" | "x" | "x2" | "y" | "y2" | "strokeDash" | "angle" | "shape" | "radius" | "theta" | "href" | "theta2" | "radius2" | "xOffset" | "yOffset" | "longitude" | "latitude" | "longitude2" | "latitude2")[];
...
export declare const NONPOSITION_CHANNELS: ("fill" | "description" | "detail" | "key" | "url" | "color" | "fillOpacity" | "opacity" | "order" | "stroke" | "strokeOpacity" | "strokeWidth" | "label" | "text" | "size" | "strokeDash" | "tooltip" | "angle" | "shape" | "href")[];
...
export declare const LABEL_INHERITABLE_CHANNEL: ("fill" | "description" | "color" | "fillOpacity" | "opacity" | "stroke" | "strokeOpacity" | "strokeWidth" | "strokeDash" | "tooltip" | "href")[];
export declare type LabelInheritableChannel = typeof LABEL_INHERITABLE_CHANNEL[number];
export declare function isLabelInheritableChannel(channel: Channel): channel is LabelInheritableChannel;
export declare const STACKABLE_CHANNELS: ("fill" | "description" | "detail" | "key" | "url" | "color" | "fillOpacity" | "opacity" | "order" | "stroke" | "strokeOpacity" | "strokeWidth" | "text" | "size" | "strokeDash" | "angle" | "shape" | "href")[];
export declare type StackableChannel = typeof STACKABLE_CHANNELS[number];
