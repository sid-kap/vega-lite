...
const UNIT_CHANNEL_INDEX = Object.assign(Object.assign(Object.assign(Object.assign({}, POSITION_CHANNEL_INDEX), POLAR_POSITION_CHANNEL_INDEX), GEO_POSIITON_CHANNEL_INDEX), { xOffset: 1, yOffset: 1, 
    ...
    order: 1, text: 1, label: 1, detail: 1, key: 1, tooltip: 1, href: 1, url: 1, description: 1 });
...
export const { size: _size, angle: _angle, shape: _shape, detail: _detail, key: _key, text: _text, label: _label, order: _order, url: _url } = NONPOSITION_CHANNEL_INDEX, LABEL_INHERITABLE_CHANNEL_INDEX = __rest(NONPOSITION_CHANNEL_INDEX, ["size", "angle", "shape", "detail", "key", "text", "label", "order", "url"]);
export const LABEL_INHERITABLE_CHANNEL = keys(LABEL_INHERITABLE_CHANNEL_INDEX);
export function isLabelInheritableChannel(channel) {
    return !!LABEL_INHERITABLE_CHANNEL[channel];
}
const { label: __label, tooltip: _tooltip } = NONPOSITION_CHANNEL_INDEX, STACKABLE_CHANNEL_INDEX = __rest(NONPOSITION_CHANNEL_INDEX, ["label", "tooltip"]);
...
detail: _dd, key: _k, order: _oo } = NONPOSITION_CHANNEL_INDEX, NONPOSITION_SCALE_CHANNEL_INDEX = __rest(NONPOSITION_CHANNEL_INDEX, ["text", "label", "tooltip", "href", "url", "description", "detail", "key", "order"]);
