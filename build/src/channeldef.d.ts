...
import { Channel, ExtendedChannel, LabelInheritableChannel, PolarPositionScaleChannel, PositionScaleChannel } from './channel';
...
declare type LabelMarkDef = Omit<MarkDef<'text'>, 'type'>;
declare type AncestorLevel = {
    /**
     * A number `n` means `n`th ancestor layer.
     */
    ancestor: number;
};
declare type LabelAvoid = 'all-marks' | 'base-mark' | AncestorLevel;
export declare function getAncestorLevel(avoid: LabelAvoid): number;
export declare type LabelDefMixins = {
    /**
...
export declare type LabelDef<F extends Field> = TextDef<F> & LabelDefMixins;
/**
